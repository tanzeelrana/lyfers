import { Box, Typography, Button, Grid, Paper, RadioGroup, FormControlLabel, Radio, Modal, IconButton, Card, CardMedia, CardContent, CardActions } from '@mui/material';
    ...
    useEffect(() => {
        const fetchProductDetail = async () => {
            try {
                ...
                const colors = JSON.parse(data.color) as string[];
            ...
            <Box padding={4}>
                <Grid container spacing={4}>
                    <Grid item xs={12} md={6}>
                        ...
                        <Paper elevation={3} >
                            <ImageGallery items={images} disableSwipe={true} showThumbnails={true} showPlayButton={false} autoPlay={true} showNav={false} showBullets={true} />
                        </Paper>
                    ...
                    <Grid item xs={12} md={6}>
                                        ...
                                        label={
                                            <Box
                                                sx={{
                                                    ...
                                                    height: 50,
                                                    borderRadius: '50%',
                                                    border: `2px solid ${selectedSize === size ? 'transparent' : 'gray'}`,
                                                    backgroundColor: selectedSize === size ? 'primary.main' : 'transparent',
                                                    color: selectedSize === size ? 'white' : 'gray',
                                                    '&:hover': {
                                                        backgroundColor: selectedSize === size ? 'primary.main' : 'lightgray',
                                                    },
                                                }}
                                            >
                        ...
                        <Box marginTop={2}>
                            <Button variant="contained" color="primary" fullWidth size='large' sx={{
                                borderRadius: '20px',
                                fontFamily: 'Outfit',
                                fontSize: '20px',
                                fontWeight: 600,
