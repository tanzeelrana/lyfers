...
const BecomeALyfer = () => {
  return (
    ...
    //   <Grid container width={"100%"} direction={"column"} padding={'15px'} rowSpacing={1} flexShrink={0}>
    //     <Grid item xs={12}>
    //       <Grid
    //         container
    //         borderRadius={'40px'}
    ...
    //         }}
    //       >
    //         <Grid item xs={12} zIndex={2} display={'inline-flex'} 
    //         sx={{
    //           gap:'10px',
    //           alignItems:'center',
    //           justifyContent:'center',
    ...
    //       <Grid container direction={"column"}  flexShrink={0} padding={3}>
    ...
    //           </Typography>
    //         </Grid>
    //         <Grid item xs={12} display={'flex'}  flexDirection={'column'} alignItems={'center'} gap={'24px'} padding={'40px'}
    //           sx={{
    ...
    //         </Grid>
    //         <Grid container direction="column" flexShrink={0}>
    //           <Grid item xs={12} container marginBottom={'20px'} sx={{
    //             backgroundColor:'#FFB892',
    //             borderRadius:'36px',
    //             padding:'40px'
    //           }}>
    //             <Grid item xs={12} md={6} display="flex" flexDirection="column">
    //                 <Typography alignSelf={'stretch'}
    //                   sx={{
    //                     fontFamily: 'Outfit',
    //                     fontSize: '40px',
    //                     fontWeight: 700,
    ...
    //                   }}
    //                 >
    //                   Resilience is the unwavering spirit to rise above adversity, the strength to overcome obstacles, and the courage to keep moving forward despite setbacks. It's about embracing challenges, learning from failures, and transforming struggles into growth opportunities. Each time you bounce back, you become stronger, wiser, and more determined. Remember, resilience is not about avoiding difficulties but facing them head-on with a positive attitude.
    //                 </Typography>
    //             </Grid>
    //             <Grid item xs={12} md={6} display="flex" alignItems="center" justifyContent={'end'} >
    //               <img
