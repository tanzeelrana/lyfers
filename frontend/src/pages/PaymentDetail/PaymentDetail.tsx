...
import { Grid, Radio, RadioGroup, FormControl, FormControlLabel, TextField, Button, Typography, Paper, Checkbox } from '@mui/material';
...
export default function PaymentDetail() {
    ...
    const handleSubmit = () => {
        ...
        if (validateForm()) {
            // Submit the form or proceed with the payment
