                                ...
                                >
                                    <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <Typography variant="body1" sx={{ fontStyle: 'inherit', verticalAlign: 'baseline' }}>
                                            ...
                                            <br /><br />
                                            Love is fresh like youth, forgiving like a gentle breeze, empowering like a guiding light, resilient like a sturdy tree, and strong like a mountain.
                                        </Typography>
                                        </Box>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} container direction={"row"} sx={{backgroundColor:'#FAFAFA'}}>
                                        <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                        <Box
                                            sx={{
                                                display: 'flex',
                                        ...
                                        <Grid item xs={12} md={6} sx={{ flexDirection: 'column', display: 'flex', alignItems: 'start', justifyContent: 'center' }}>
                                        <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 2 }}>
                                            Youthfulness
                                            </Typography>
                                            <Box
                                    ...
                                    <Grid item xs={12} container direction={"row"} sx={{backgroundColor:'white'}}>
                                        <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                            <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 2 }}>
                                            Empowering
                                            </Typography>
